  ...
  return (
    <section className='section bg-second_bg pb-[5vh]' id='contact'>
      ...
      <div  className='relative w-full flex flex-col lg:flex-row lg:justify-between lg:items-center'>
        ...
        <Image data-aos='fade-right' src={send_email} alt='send email image' className='w-full lg:w-fit lg:mr-auto' />


        <div data-aos='fade-left' className='flex flex-col justify-start items-start w-full px-2 lg:pl-4 gap-y-4 animate-float'>
        ...
        <div className='w-full grid grid-cols-2 gap-x-8 gap-y-8 translate-y-[-50px] lg:translate-y-0 lg:translate-x-[-80px] lg:flex lg:justify-center lg:items-center'>
          ...
          <Link href='/' className='group flex flex-col gap-y-8 glass-eff border-2 p-4 rounded-lg border-border_color duration-300 hover:translate-y-[-12px]'>
